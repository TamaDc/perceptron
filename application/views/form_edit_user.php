				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						...
						<div class="tab-content">
                          ...
                          <div align="center">
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url()."index.php/admin/update_user"; ?>">
                                <tr>  
                                  <th width="150">
                                ...
                                <tr>  
                                  ...
                                  <th width="750">
                                    <div class="col-sm-10">
                                      <input type="text" autocomplete="off" required="required" class="form-control" id="username" name="username"  value="<?php echo $data['username'] ?>">
                                    </div>
                                  </div>
                                  </th>
                                </tr>
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <div class="col-sm-10">
                                      <input type="password" class="form-control" id="password" required="required" name="password"  value="<?php echo $data['password']; ?>">
                                      </div>
                                  </td>
                                  </tr>
                                  <tr><th colspan="2" >
                                  ...
                                  <div class="col-sm-10 col-sm-offset-2">
                                      <a class="btn btn-danger" href="<?php echo base_url()."index.php/admin/user/"; ?>">Cancel</a> 
