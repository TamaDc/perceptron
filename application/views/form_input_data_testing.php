...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
            ...
            <h1 align="center">Insert Data Peserta IKS PI Kera sakti</h1>
						<div class="tab-content">
							<div class="tab-pane fade in active" id="tab1">
									<table border="0" style="width: 500px"; align="center">

                          <div align="center">
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url()."index.php/admin/insert_data_testing"; ?>">
                                <tr>  
                                  <th width="200">
                                ...
                                <tr>
                                  ...
                                  <tr>
                                    <td>
                                      <div class="form-group">
                                        <label for="Golongan" class="col-sm-2 control-label">Target</label>
                                      </div>
                                    </td>
                                    <td>
                                      <div class="col-sm-10">
                                       <select name="target" id="target" class="form-control">
                                        <option value="1">Berbakat</option>>
                                        <option value="0">Tidak Berbakat</option>
                                      </select>
                                      </div>
                                    </td>
                                  </tr>
