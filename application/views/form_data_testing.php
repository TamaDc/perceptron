	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Bakat Siswa</li>
			</ol>
		</div><!--/.row-->
		
	<!-- 	<div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Table Insert Minat</h2>
			</div>
		</div><!--/.row--> 
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
							<a class="btn btn-primary" href="<?php echo base_url()."index.php/admin/form_input_data_testing"; ?>" >Tambah Data</a> - 
							<a class="btn btn-success" href="<?php echo base_url()."index.php/admin/proses_prepocessing_testing"; ?>" >Preprocessing Data</a>
						    <thead>
						    <tr>
						    ...
						    <tr>
						    	...
						    	<!-- <td ><center>
                            		<a class="btn btn-default" href="<?php echo base_url()."index.php/admin/show_profile/".$data['NIP']; ?>" >Profile</a>  
                            		<a class="btn btn-success" href="<?php echo base_url()."index.php/admin/edit/".$data['NIP']; ?>" >Edit</a>
                            		<a class="btn btn-danger" href="<?php echo base_url()."index.php/admin/delete/".$data['NIP']; ?>" >Delete</a>
                            		</center>          
                                </td> -->
						    </tr>
						    <?php } ?> 
