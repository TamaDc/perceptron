	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Minat Siswa</li>
			</ol>
		</div><!--/.row-->
		
		<!-- <div class="row">
			<div class="col-lg-12">
				<h2 class="page-header">Table Insert Kuisoner</h2>
			</div>
		</div> --><!--/.row-->
					...
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="Action" data-sortable="true" width="50">Action</th>
						    ...
						    <tr>
						    	...
						    	<td><?php echo $data['target']; ?></td>
						    	 ...
						    	 <td ><center>
                            		...
                            		<a class="btn btn-success" href="<?php echo base_url()."index.php/admin/edit_kuisoner_testing/".$data['ID']; ?>" >Kuisoner</a>
                            		</center>          
                                </td> 
						    </tr>
						    <?php } ?> 
