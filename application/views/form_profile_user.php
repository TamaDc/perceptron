...
<body>
    ...
    <div id="page-wrap" a;>
        ...
        <dl>
            ...
            <dd>
                <h2>Doomsday Cult</h2>
                <ul>
                    <strong>Golongan:</strong><?php echo $data2['golongan']; ?><br />
                   <strong>TMT Pangkat:</strong><?php echo $data2['tmt_pangkat']; ?></br>
                   <strong>Grade:</strong><?php echo $data2['grade']; ?></br>
                   <strong>Gaji:</strong><?php echo $data2['gaji']; ?></p>
                   <strong>TMT KGB Terakhir:</strong><?php echo $data2['tmt_kgb']; ?></p>
    ...
    <p align="right">
    <a class="btn btn-default" href="<?php echo base_url()."index.php/user/Edit/".$data['NIP']; ?>" >Edit</a> ||
    <a class="btn btn-success" target="_blank" href="<?php echo base_url()."index.php/admin/print_profile/".$data['NIP']; ?>" >Print</a> </p>
    </div>
