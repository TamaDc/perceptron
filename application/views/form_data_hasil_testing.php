	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Hasil Data Testing</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading" align="center">Hasil Pengujian Data Testing</div> 
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="tables/data1.json"  >
						    ...
						    <tr>
						        ...
						        <th data-field="TP" data-sortable="true" width="50">TP</th>
						        <th data-field="TN"  data-sortable="true" width="50">TN</th>
						        <th data-field="FP" data-sortable="true" width="50">FP</th>
						        <th data-field="FN"  data-sortable="true" width="50">FN</th>
						        <th data-field="Hasil" data-sortable="true" width="50">Akurasi</th>
						    </tr>
						    </thead>
