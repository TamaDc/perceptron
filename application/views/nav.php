<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Penentuan</span> Minat<span> Bakat</span> Olahraga Pencak Silat</a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li>
								<a href="<?php echo base_url()."index.php/Login/logout/"; ?>"><svg class="glyph stroked cancel">
