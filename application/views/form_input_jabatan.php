				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						...
						<div class="tab-content">
                          ...
                          <div align="center">
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url()."index.php/admin/insert_jabatan"; ?>">
                                <tr>  
                                  <th width="150">
                                  ...
                                  <th width="750">
                                    <div class="col-sm-10">
                                      <input type="text" autocomplete="off" required="required" class="form-control" id="jabatan" name="jabatan" placeholder="Kepala perusahaan" value="">
                                    </div>
                                  </div>
                                  </th>
                                </tr>
