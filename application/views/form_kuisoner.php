				...
				<div class="panel panel-default">
					<div class="panel-body tabs">
						...
						<ul class="nav nav-tabs">
							<li class="active"><a href="#tab1" data-toggle="tab">Pilihan Kuisoner</a></li>
						</ul>
                          ...
                          <div align="center">
                            <form class="form-horizontal" role="form" method="POST" action="<?php echo base_url()."index.php/admin/update_pegawai"; ?>">
                                <tr>  
                                  ...
                                  <th width="400">
                                    <div class="col-sm-10">
                                      <input type="text" readonly autocomplete="off" required="required" class="form-control" id="ID" name="ID" value="<?php echo $data['ID'];  ?>">
                                    </div>
                                  </div>
                                  </th>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                      <div class="form-group">
                                        <label for="Golongan" class="col-sm-2 control-label"><p>Apakah_olahraga_yang_saudara_sukai?</p></label>
                                      </div>
                                    </td>
                                    <td>
                                      <div class="col-sm-10">
                                  ...
                                  <tr>
                                    <td>
                                      <div class="form-group">
                                        <label for="Golongan" class="col-sm-2 control-label">Olahraga_apa_yang_sering_kamu_tonton_ditelevisi?</label>
                                      </div>
                                    </td>
                                    <td>
                                      <div class="col-sm-10">
