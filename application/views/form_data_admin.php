				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<table data-toggle="table" data-url="tables/data1.json"  data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
							<a class="btn btn-primary" href="<?php echo base_url()."index.php/admin/form_input_admin"; ?>" >Tambah Data</a>
						    <thead>
						    <tr>
						    ...
						    <tr>
						    	...
						    	<td ><center>
                            		...
                            		<a class="btn btn-success" href="<?php echo base_url()."index.php/admin/edit_admin/".$data['id']; ?>" >Edit</a>
                            		<a class="btn btn-danger" href="<?php echo base_url()."index.php/admin/delete_admin/".$data['id']; ?>" >Delete</a>
                            		</center>          
                                </td>
						    </tr>
						    <?php } ?> 
